            ...
            <div class="container">
                ...
                <div class="navbar-links">
                    <ul class="nav-links">
                        ...
                        <li><a href="create_user.php">Contact_user</a></li>
                        <li><a href="pages/booking.php">Book table</a></li>
                    </ul>
                    <div class="auth-links">
                        <a href="logout.php" class="login-link"><i class="fas fa-sign-in-alt"></i> LogOut </a>
                        <div class="cart">
    ...
    <main class="adminpage">
        ...
        if (isset($_GET['edit'])) {
            ...
            <form method="post" action="admin_panel.php" enctype="multipart/form-data">
                ...
                <input type="file" name="image" accept="image/*">
                <label>Or Image URL:</label>
                <input type="url" name="image_url" value="<?php echo $product['image']; ?>" placeholder="http://example.com/image.jpg">
